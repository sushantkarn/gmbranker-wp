...
if (!defined('GMB_RANKER_SEO_VERSION')) {
    define('GMB_RANKER_SEO_VERSION', '2.3.0');
}
 ...
 */
if (!function_exists('gmb_ranker_seo_activate')) {
 ...
 */
if (!function_exists('gmb_ranker_seo_deactivate')) {
 ...
 */
if (!function_exists('gmb_ranker_seo_upgrade')) {
 ...
 *
 * @return GMB_Ranker_SEO_Core|null
 */
if (!function_exists('gmb_ranker_seo_init')) {
