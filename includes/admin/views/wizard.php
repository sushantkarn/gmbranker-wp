        ...
        <div class="wiz-step-pane" id="wiz-pane-2">
            ...
            <form id="wiz-form-site">
                ...
                <div class="wiz-form-row">
                    ...
                    <div class="wiz-form-input-col">
                        <input type="text" id="wiz_org_name" class="wiz-input" value="<?php echo esc_attr($org_name); ?>" placeholder="e.g. Care Nest Nepal" />
...
(function($) {
    ...
    var currentStep = 1;
    var totalSteps = 6;
    var wizardNonce = '<?php echo esc_js($wizard_nonce); ?>';
