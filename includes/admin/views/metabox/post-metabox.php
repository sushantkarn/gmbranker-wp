...
<!-- Single Page AI SEO Optimizer Modal -->
<div id="gmb-ai-post-seo-modal" class="gmb-modal-overlay">
    <div class="gmb-modal-container gmb-modal-lg">
        <div class="gmb-modal-header">
            <h3 class="gmb-modal-title">✨ AI SEO Master Strategist — Auto-Optimize Page</h3>
        ...
        <div class="gmb-modal-body">
            <div id="gmb-ai-post-modal-loading" class="gmb-ai-loading-box">
                ...
                <p class="gmb-ai-loading-text">Reading page content, title, headings, and site URLs with AI...</p>
            </div>
            <div id="gmb-ai-post-modal-content" class="gmb-hidden">
                <div class="gmb-ai-results-grid">
                    <!-- Left Column: Primary Metadata Improvements -->
                    <div class="gmb-ai-meta-column">
                        <div class="gmb-card-sm gmb-mb-14">
                            <label class="gmb-form-label-sm">Focus Keyword Suggestion</label>
                            <input type="text" id="gmb-ai-res-focus" class="gmb-field-input" />
                        </div>
                        <div class="gmb-card-sm gmb-mb-14">
                            <label class="gmb-form-label-sm">SEO Title</label>
                            <input type="text" id="gmb-ai-res-title" class="gmb-field-input" />
                        </div>
                        <div class="gmb-card-sm gmb-mb-14">
                            <label class="gmb-form-label-sm">Meta Description</label>
                            <textarea id="gmb-ai-res-desc" rows="3" class="gmb-field-textarea"></textarea>
                        </div>
                        <div class="gmb-card-sm gmb-mb-14">
                            <label class="gmb-form-label-sm">URL Slug</label>
                            <input type="text" id="gmb-ai-res-slug" class="gmb-field-input" />
                        </div>
                        <div class="gmb-card-sm">
                            <label class="gmb-form-label-sm">Recommended Schema Preset</label>
                            <select id="gmb-ai-res-schema" class="gmb-field-select">
                    ...
                    <!-- Right Column: Internal Links & Enhancements -->
                    <div class="gmb-ai-links-column">
                        <h4 class="gmb-heading-4 gmb-mb-10">Smart Internal Link Suggestions</h4>
                        <div id="gmb-ai-internal-links-box" class="gmb-links-list-box gmb-mb-16">
                            <!-- Populated via JS -->
                        </div>

                        <h4 class="gmb-heading-4 gmb-mb-10">Optimization Improvements Applied</h4>
                        <ul id="gmb-ai-tips-list" class="gmb-ai-tips-ul">
                            <!-- Populated via JS -->
                        </ul>
                    </div>
                </div>
        ...
        <div class="gmb-modal-footer">
            ...
            <button type="button" class="button button-primary gmb-btn--primary" id="gmb-ai-post-apply-btn" disabled>Apply Selected AI Recommendations</button>
        </div>
    </div>
</div>
