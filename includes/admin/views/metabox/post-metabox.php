    ...
    <div class="gmb-tab-content" id="gmb-tab-schema" role="tabpanel">
        ...
        <div class="gmb-modal-backdrop" id="gmb-schema-modal" aria-hidden="true" role="dialog">
            <div class="gmb-modal-box gmb-modal-box-schema">
                ...
                <div class="gmb-modal-tabs" role="tablist">
                    <span class="gmb-modal-tab-btn active" data-schema-tab="schema-tab-templates" role="tab"><?php esc_html_e('Schema Templates', 'gmb-ranker-seo-automation'); ?></span>
                    <span class="gmb-modal-tab-btn" data-schema-tab="schema-tab-import" role="tab"><?php esc_html_e('Import', 'gmb-ranker-seo-automation'); ?></span>
                    <span class="gmb-modal-tab-btn" data-schema-tab="schema-tab-custom" role="tab"><?php esc_html_e('Custom Schema', 'gmb-ranker-seo-automation'); ?></span>
                </div>
                <div class="gmb-modal-body gmb-modal-body-scroll">
