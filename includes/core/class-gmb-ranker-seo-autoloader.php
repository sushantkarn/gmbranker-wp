...
class GMB_Ranker_SEO_Autoloader {
    ...
    public static function register() {
        ...
        self::$class_map = array(
            ...
            'GMB_Ranker_SEO_Tools_Registry'       => self::$base_path . '/core/class-gmb-ranker-seo-tools-registry.php',
            'GMB_Ranker_SEO_Wizard_Registry'      => self::$base_path . '/core/class-gmb-ranker-seo-wizard-registry.php',
            ...
            'GMB_Ranker_SEO_REST_Automation_Controller' => self::$base_path . '/rest/class-rest-automation-controller.php',
            'GMB_Ranker_SEO_MCP_Bridge'        => self::$base_path . '/modules/mcp/class-gmb-ranker-seo-mcp-bridge.php',
            'GMB_Ranker_SEO_MCP_Tools'         => self::$base_path . '/modules/mcp/class-gmb-ranker-seo-mcp-tools.php',
            ...
            'GMB_Ranker_SEO_GA4_Client'        => self::$base_path . '/api/class-ga4-client.php',
